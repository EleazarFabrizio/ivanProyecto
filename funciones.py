...
import sqlite3
conexion = sqlite3.connect("Base_de_datos.bd")
...
def fin_Juego(ventana_JuegoOn, pregunta_frame):
    ...
    cursor.execute("INSERT INTO Jugador (nombre, telefono, instagram, puntaje, tiempo) values (?,?,?,?,?)", (lista_jugador[0], lista_jugador[1], lista_jugador[2], contador_correctas*100, tiempo_total))
    conexion.commit()
